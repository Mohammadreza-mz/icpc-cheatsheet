...
• Initialization: Use memset/clear(). Dont expect global variables to be zero. Care about multiple tests 
...
• Geometry: Distance may not overflow, but its square or cross may does
• Implementation: be careful about numbers limits to fit in long long in implementation problems with no given limits
• If the problem has too many accepts maybe you are thinking too hard!
• Apply the simplest, random, or ternary search with block min/max at the last hour if you have not any solutions